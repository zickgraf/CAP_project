...
function ( cat_1, arg2_1, arg3_1 )
    local hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, hoisted_10_1, hoisted_11_1, hoisted_12_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1;
    deduped_18_1 := OppositeCategory( cat_1 );
    deduped_17_1 := Opposite( arg3_1 );
    deduped_16_1 := Opposite( arg2_1 );
    deduped_15_1 := Dimension( deduped_16_1 );
    deduped_14_1 := Dimension( deduped_17_1 );
    deduped_13_1 := deduped_14_1 * deduped_15_1;
    hoisted_12_1 := CreateCapCategoryObjectWithAttributes( cat_1, Opposite, deduped_17_1 );
    hoisted_11_1 := CreateCapCategoryObjectWithAttributes( cat_1, Opposite, deduped_16_1 );
    ...
    hoisted_5_1 := HomalgIdentityMatrix( deduped_13_1, UnderlyingRing( deduped_18_1 ) );
    hoisted_4_1 := [ 1 .. deduped_13_1 ];
    return ListWithKeys( hoisted_4_1, function ( key_2, logic_new_func_x_2 )
            return CreateCapCategoryMorphismWithAttributes( cat_1, hoisted_11_1, hoisted_12_1, Opposite, CreateCapCategoryMorphismWithAttributes( hoisted_8_1, hoisted_9_1, hoisted_10_1, UnderlyingMatrix, ConvertRowToMatrix( CertainRows( hoisted_5_1, [ logic_new_func_x_2 ] ), hoisted_6_1, hoisted_7_1 ) ) );
        end );
end
########
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    deduped_6_1 := Opposite( s_1 );
    deduped_5_1 := OppositeCategory( cat_1 );
    deduped_4_1 := Dimension( deduped_6_1 );
    hoisted_3_1 := Dimension( Opposite( a_1 ) );
    hoisted_2_1 := Dimension( Opposite( b_1 ) );
    hoisted_1_1 := [ 1 .. deduped_4_1 ];
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_5_1, deduped_6_1, Opposite( r_1 ), UnderlyingMatrix, HomalgMatrix( PermutationMat( PermList( ListWithKeys( hoisted_1_1, function ( key_2, i_2 )
                      local deduped_1_2;
                      deduped_1_2 := i_2 - 1;
                      return REM_INT( deduped_1_2, hoisted_2_1 ) * hoisted_3_1 + QUO_INT( deduped_1_2, hoisted_2_1 ) + 1;
                  end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, UnderlyingRing( deduped_5_1 ) ) ) );
end
########
...
function ( cat_1, alpha_1, S_1, i_1 )
    ...
    deduped_2_1 := ListWithKeys( S_1, function ( key_2, logic_new_func_x_2 )
            return Dimension( Opposite( logic_new_func_x_2 ) );
        end );
    deduped_1_1 := Sum( deduped_2_1{[ 1 .. i_1 - 1 ]} ) + 1;
    return CreateCapCategoryMorphismWithAttributes( cat_1, S_1[i_1], Range( alpha_1 ), Opposite, CreateCapCategoryMorphismWithAttributes( OppositeCategory( cat_1 ), Source( deduped_3_1 ), ListWithKeys( S_1, function ( key_2, x_2 )
                  return Opposite( x_2 );
...
function ( cat_1, alpha_1, S_1, i_1 )
    ...
    deduped_1_1 := Sum( deduped_2_1{[ 1 .. i_1 - 1 ]} ) + 1;
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), S_1[i_1], Opposite, CreateCapCategoryMorphismWithAttributes( OppositeCategory( cat_1 ), ListWithKeys( S_1, function ( key_2, x_2 )
                  return Opposite( x_2 );
...
########
function ( cat_1, arg2_1 )
    return CreateCapCategoryObjectWithAttributes( cat_1, Opposite, CreateCapCategoryObjectWithAttributes( OppositeCategory( cat_1 ), Dimension, Sum( ListWithKeys( arg2_1, function ( key_2, logic_new_func_x_2 )
                  return Dimension( Opposite( logic_new_func_x_2 ) );
              end ) ) ) );
end
########
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    local deduped_1_1;
    deduped_1_1 := OppositeCategory( cat_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_1_1, Opposite( Pp_1 ), Opposite( P_1 ), UnderlyingMatrix, DiagMat( UnderlyingRing( deduped_1_1 ), ListWithKeys( L_1, function ( key_2, logic_new_func_x_2 )
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    deduped_2_1 := ListWithKeys( objects_1, function ( key_2, logic_new_func_x_2 )
            return Dimension( Opposite( logic_new_func_x_2 ) );
        end );
    deduped_1_1 := deduped_2_1[k_1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, objects_1[k_1], P_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_4_1, Opposite( P_1 ), ListWithKeys( objects_1, function ( key_2, x_2 )
                  return Opposite( x_2 );
...
function ( cat_1, S_1, source_diagram_1, mat_1, range_diagram_1, T_1 )
    ...
    deduped_4_1 := CAP_INTERNAL_OPPOSITE_RECURSIVE( [ cat_1, S_1, source_diagram_1, mat_1, range_diagram_1, T_1 ] );
    deduped_3_1 := deduped_4_1[2];
    hoisted_2_1 := deduped_5_1;
    hoisted_1_1 := TransposedMatImmutable( deduped_4_1[4] );
    return CreateCapCategoryMorphismWithAttributes( cat_1, S_1, T_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_6_1, deduped_4_1[6], deduped_3_1, UnderlyingMatrix, UnionOfRows( deduped_5_1, Dimension( deduped_3_1 ), ListN( deduped_4_1[5], ListWithKeys( hoisted_1_1, function ( key_2, row_2 )
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    deduped_1_1 := deduped_2_1[k_1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, objects_1[k_1], Opposite, CreateCapCategoryMorphismWithAttributes( deduped_4_1, ListWithKeys( objects_1, function ( key_2, x_2 )
                  return Opposite( x_2 );
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    deduped_1_1 := OppositeCategory( cat_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_1_1, deduped_2_1, Opposite( P_1 ), UnderlyingMatrix, UnionOfColumns( UnderlyingRing( deduped_1_1 ), Dimension( deduped_2_1 ), ListWithKeys( tau_1, function ( key_2, logic_new_func_x_2 )
                  return UnderlyingMatrix( Opposite( logic_new_func_x_2 ) );
              end ) ) ) );
end
########
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    deduped_2_1 := Opposite( T_1 );
    deduped_1_1 := OppositeCategory( cat_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, Opposite, CreateCapCategoryMorphismWithAttributes( deduped_1_1, Opposite( P_1 ), deduped_2_1, UnderlyingMatrix, UnionOfRows( UnderlyingRing( deduped_1_1 ), Dimension( deduped_2_1 ), ListWithKeys( tau_1, function ( key_2, logic_new_func_x_2 )
                  return UnderlyingMatrix( Opposite( logic_new_func_x_2 ) );
              end ) ) ) );
end
########
