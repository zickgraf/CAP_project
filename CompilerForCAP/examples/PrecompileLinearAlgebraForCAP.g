...
CapJitPrecompileCategoryAndCompareResult(
    ...
    #operations := "HomologyObjectFunctorialWithGivenHomologyObjects",
    #operations := [ "InternalHomToTensorProductAdjunctionMap", "LambdaElimination", "MorphismFromBidual", "MorphismFromBidualWithGivenBidual" ] ),
