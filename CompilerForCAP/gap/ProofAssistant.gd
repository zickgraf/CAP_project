...
DeclareGlobalName( "CAP_JIT_PROOF_ASSISTANT_ACTIVE_CATEGORY" );
DeclareGlobalName( "CAP_JIT_PROOF_ASSISTANT_ACTIVE_CATEGORY_SYMBOLS" );
DeclareGlobalName( "CAP_JIT_PROOF_ASSISTANT_MODE_ACTIVE_THEOREM" );
