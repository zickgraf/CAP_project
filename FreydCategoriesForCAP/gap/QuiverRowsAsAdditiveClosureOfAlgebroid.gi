...
##
InstallMethod( QuiverRowsAsAdditiveClosureOfAlgebroid,
               [ IsQuiverAlgebra, IsBool ],
               
  function( underlying_quiver_algebra, over_Z )
    local ring, paths, category_name, underlying_quiver, algebroid, category, name, p, q, constructin;
    ...
    algebroid := Algebroid( underlying_quiver_algebra );
    ...
    category := AdditiveClosure( algebroid : name := category_name );
    
    DeactivateCachingOfCategory( category );
    
    CapCategorySwitchLogicOff( category );
    
    DeactivateCachingOfCategory( RangeCategoryOfHomomorphismStructure( category ) );
    CapCategorySwitchLogicOff( RangeCategoryOfHomomorphismStructure( category ) );
