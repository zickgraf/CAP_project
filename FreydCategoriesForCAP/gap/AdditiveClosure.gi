            ...
            AddHomomorphismStructureOnMorphismsWithGivenObjects( category,
              function( cat, source, alpha, beta, range )
                ...
                H_B_C :=
                    List( [ 1 .. size_j ], j ->
                        List( [ 1 .. size_s ], s ->
                            HomomorphismStructureOnObjects( underlying_category, B[j], C[s] )
                        )
                    );
                ...
                H_A_D :=
                    List( [ 1 .. size_i ], i ->
                        List( [ 1 .. size_t ], t ->
                            HomomorphismStructureOnObjects( underlying_category, A[i], D[t] )
                        )
                    );
                        ...
                        List( [ 1 .. size_j ], j ->
                          List( [ 1 .. size_i ], i ->
                            MorphismBetweenDirectSumsWithGivenDirectSums(
                              ...
                              List( [ 1 .. size_s ], s ->
                                List( [ 1 .. size_t ], t ->
                                  HomomorphismStructureOnMorphisms( underlying_category, alpha[i, j], beta[s, t] )
                                )
                              ),
